...
class Deka_model extends CI_Model {
	...
	public function antrian(){
		$sql = "SELECT rekam_medispasien.nama_pasien, pasien.gender_pasien FROM pasien JOIN rekam_medis on rekam_medis.pasien_id_pasien = pasien.id_pasien WHERE rekam_medis.status = '0' AND rekam_medis.tanggal_periksa IN
			(
